		...
		>
			...
			<main className="grid grid-cols-1 grid-rows-2 lg:grid-cols-2 lg:grid-rows-1 print:grid-cols-2 print:grid-rows-1">
				...
				>
					...
					>
						<SVGIcon path="M1.8 3.6a1.8 1.8 0 0 1 1.8-1.8h6a.6.6 0 0 1 .48.96L8.55 4.8l1.53 2.04a.6.6 0 0 1-.48.96h-6a.6.6 0 0 0-.6.6v1.8a.6.6 0 1 1-1.2 0V3.6Z" />
					</SectionHeader>
	...
	<address className="p-4">
		<ul className="space-y-2" aria-label="Contact Information">
			<ContactItem ariaLabel="Phone Number">
				<SVGIcon path="M6.78.628a.6.6 0 0 1 .42.572v3h2.4a.6.6 0 0 1 .492.944l-4.2 6A.6.6 0 0 1 4.8 10.8v-3H2.4a.6.6 0 0 1-.492-.944l4.2-6A.6.6 0 0 1 6.78.628Z"></SVGIcon>
			...
			<ContactItem ariaLabel="LinkedIn Profile">
				<SVGIcon path="M11 11H8.778V7.25c0-.589-.661-1.078-1.25-1.078-.59 0-.972.49-.972 1.078V11H4.333V4.333h2.223v1.111c.366-.594 1.31-.977 1.955-.977A2.5 2.5 0 0 1 11 6.972V11Zm-7.778 0H1V4.333h2.222V11ZM2.112 1a1.111 1.111 0 1 1 0 2.222 1.111 1.111 0 0 1 0-2.222Z"></SVGIcon>
