const Page1 = () => {
	return (
		<div className="absolute inset-0 flex items-center justify-center">
			...
			<p className="absolute inset-x-auto text-sm font-semibold tracking-wider text-center text-white bottom-32 opacity-60">
				Scroll down
			</p>

			{/* Scroll down arrow  */}
			<p className="absolute inset-x-auto text-white bottom-12 opacity-60">
				<svg
